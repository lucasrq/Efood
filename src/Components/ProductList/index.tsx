...
const ProcutsList = () => (
    <Container>
        <List>
            ...
            <Product 
                id={3} 
                image="../../public/img/hamburgues.jpeg" 
            ...
            <Product 
                id={4} 
                image="../../public/img/restauranteVinheto.jpeg" 
